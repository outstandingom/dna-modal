...
# ============================================================
# DNA Concept — Core Innovation: gradient backprop through
# the sinusoidal DNA encoding
# ============================================================
class DNAConcept:
    ...
    def move_towards(self, other: 'DNAConcept', lr: float = LR_CONCEPT):
        """
        Core innovation: move concept vectors closer and backpropagate
        the gradient through to the underlying feature vectors and letter
        vectors via the sinusoidal encoding chain.
        """
        ...
        # Backpropagate gradient through sin encoding to feature & letter vecs
...
# ============================================================
# Reasoning Engine — multi-hop + analogical reasoning
# ============================================================
class ReasoningEngine:
    ...
    def analogical_reasoning(self, a: str, b: str, c: str) -> List[str]:
        """A is to B as C is to ? — vector arithmetic analogy."""
